...
parser.add_argument('--load_model', type=str, default='/data/NetworkModels/B2fold5/ADClassifier_B2_fold_5_epoch_147.model', metavar='str',
...
parser.add_argument('--initial_kernel', type=int, default=16, metavar='N',
                    help='input_channel')
parser.add_argument('--cv', type=int, default=5, metavar='N',
...
def load_data():
    ...
    #
    # dset_val = ReadImagesCrossValidation(args.data, train=False, neg_type='CN', pos_type='AD', cv=args.cv)
    #
...
def test(model, device, test_loader, epoch):
    ...
    print('\nAccuracy: {}/{} ({:.4f}%)\tSEN: {:.4f}%\tSPE: {:.4f}%\tAUC: {:.6f}\n'.
